...
namespace YARG.Settings.Preview
{
    public class FakeTrackPlayer : MonoBehaviour
    {
        public abstract class Info
        {
            ...
            public abstract void Init(FretArray array, in PresetContainer<ThemePreset> themePreset, GameMode gameMode);
        ...
        {
            public delegate ref readonly TProvider FretColorProviderFunc(in ColorProfile c);
            ...
            public override void Init(FretArray array, in PresetContainer<ThemePreset> themePreset, GameMode gameMode)
            {
                array.Initialize(themePreset, gameMode, FretColorProvider(ColorProfile.Default.Config), false);
            }

            public override void InitColor(FretArray array, ColorProfile profile)
            {
                array.InitializeColor(FretColorProvider(profile), false);
            }
        }
        ...
        {
            {
                ...
                new FretColorInfo<ColorProfile.FiveFretGuitarColors>(
                    fretCount: 5,
                    useKickFrets: false,
                    fretColorProvider: (in ColorProfile colorProfile) => ref colorProfile.FiveFretGuitar,
            ...
            },
            {
                ...
                new FretColorInfo<ColorProfile.FourLaneDrumsColors>(
                    fretCount: 4,
                    useKickFrets: true,
                    fretColorProvider: (in ColorProfile colorProfile) => ref colorProfile.FourLaneDrums,
            ...
            },
            {
                ...
                new FretColorInfo<ColorProfile.FiveLaneDrumsColors>(
                    fretCount: 5,
                    useKickFrets: true,
                    fretColorProvider: (in ColorProfile colorProfile) => ref colorProfile.FiveLaneDrums,
