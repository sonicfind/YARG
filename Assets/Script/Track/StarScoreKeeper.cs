...
namespace YARG.PlayMode
{
    ...
    public class StarScoreKeeper
    {
        ...
        /// </summary>
        public static readonly float[] starThresholdsDefault =
        {
            .21f, .46f, .77f, 1.85f, 3.08f, 4.52f
        };

        /// <summary>
        /// Minimum avg. multipliers to get 1, 2, 3, 4, 5, and gold stars on Bass respectively.
        /// </summary>
        public static readonly float[] starThresholdsBass =
        {
            .21f, .5f, .9f, 2.77f, 4.62f, 6.78f
        };

        /// <summary>
        /// Minimum avg. multipliers to get 1, 2, 3, 4, 5, and gold stars on Drums respectively.
        /// </summary>
        public static readonly float[] starThresholdsDrums =
        {
            .21f, .46f, .77f, 1.85f, 3.08f, 4.29f
        };

        /// <summary>
        /// Minimum avg. multipliers to get 1, 2, 3, 4, 5, and gold stars on Vocals respectively.
        /// </summary>
        public static readonly float[] starThresholdsVocals =
        {
            .21f, .46f, .77f, 1.85f, 3.08f, 4.18f
        };
        ...
        public double Stars
        {
            ...
            {
                int stars = 5;
                while (stars >= 0 && scoreKeeper.Score < scoreThresholds[stars])
                {
                    --stars;
                }
                ...
                switch (stars)
                {
                    ...
                    case int s when s <= 5:
                        return (double) s + (scoreKeeper.Score - scoreThresholds[s - 1]) /
                            (scoreThresholds[s] - scoreThresholds[s - 1]);
                    default: // 6+ stars
                        return (double) 5 + (scoreKeeper.Score - scoreThresholds[4]) /
                            (scoreThresholds[5] - scoreThresholds[4]);
                }
            }
        }
