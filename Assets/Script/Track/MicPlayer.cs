...
namespace YARG.PlayMode
{
    public sealed class MicPlayer : MonoBehaviour
    {
        ...
        {
            new Color32(0, 204, 255, 255), new Color32(255, 133, 0, 255), new Color32(255, 219, 0, 255)
        };
        ...
        public static MicPlayer Instance { get; private set; }
        ...
        public EventInfo CurrentPhraseEnd => _phraseEndIndex < _endPhrases.Count ? _endPhrases[_phraseEndIndex] : null;
        ...
        public void SetPlayerScore()
        {
            ...
            var score = new PlayerManager.LastScore
            {
                ...
                {
                    difficulty = _micInputs[0].Player.chosenDifficulty, percent = percentage
                },
                score = new DiffScore
                {
        ...
        private void Update()
        {
            ...
            {
                float compensation =
                    TRACK_SPAWN_OFFSET - CalcLagCompensation(TrackStartTime, CurrentVisualPhraseEnd.time);
